...
# ==========================================
# 1. IMPOSTAZIONE DELLA DATA DEL BACKTEST
# ==========================================
backtest_yr <- 1997
backtest_mo <- 5
...
if(length(idx_backtest) == 0) stop("Data non trovata!")
...
# Configurazione dell'input del test scalato secondo la statistica del passato
...
# Applichiamo la componente di accelerazione fisica (Forzante NOAA)
